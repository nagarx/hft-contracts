...
Phase 6 6B.3 (2026-04-17): Moved from ``hft_ops.feature_sets.hashing`` to
``hft_contracts.feature_sets.hashing``. Already imported from
``hft_contracts.canonical_hash`` for the primitives; now also lives
under hft_contracts for the content-addressing wrapper.
"""
