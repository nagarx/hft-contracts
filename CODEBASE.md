...
> **Version**: 2.3.0 | **Schema Version**: 3.0 (Phase G G.6.A bump 2.2 → 3.0 MAJOR per CLAUDE.md root rule: any modification to stable features 0-97 = BREAKING) | **Tests**: 518 passing (post Phase A.5.1 `timestamp_utils` SSoT + A.5.6 horizons list/tuple round-trip regression + A.5.7b documentation regression + Phase G.6.A→G.6.F cascade) | **Last Updated**: 2026-04-27 (REV 3.1 Phase G G.6.A→G.6.F cycle)
>
